...
<!--
A function may not take an autoclosure parameter of `async` function type ufnless the function itself is `async`. For example, the following declaration is ill-formed:
-->
