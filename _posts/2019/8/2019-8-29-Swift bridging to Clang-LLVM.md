...
- 代码规模
  ...
  ![](../../../../assets/Clang-LLVM/Clang/Clang+LLVM.png)

  对比Swift Frontend 代码规模，就少很多，只有43W行左右。可能在后端，比如优化器策略，生成机器码部分就有很多代码：
  ![](../../../../assets/Clang-LLVM/Clang/Swift-fronted.png)
...
- Clang命令Clang在概念上是编译器前端，同时，在命令行中也作为一个“黑盒”的 Driver;
  ...
  当我们点击run命令以后，如下图：
  ![](../../../../assets/Clang-LLVM/Clang/Run-Clang.png)

  就是我们在**build setting**中的一些设置，组装成命令，下面可以看到是一个 oc文件在arc环境下的编译过程：
  ![](../../../../assets/Clang-LLVM/Clang/Run-Clang2.png)
...
1. **Preprocess - 预处理**import 头文件，include头文件等 
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Clang-main.png)
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Clang-main2.png)
...
2. **Lexical Analysis - 词法分析**
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Lexical-Analysis.png)
...
3. **Analysis - 语法分析**
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Analysis.png)

   可以通过语法树，反写回源码，如下图：

   ![](../../../../assets/Clang-LLVM/Clang/AST.png)
...
4. **Static Analysis - 静态分析**(不是必须的)
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Static-Analysis.png)
...
5. **CodeGen - IR 代码生成**CodeGen负责将语法树从顶至下遍历，翻译成LLVM IR，LLVMIR 是Frontend的输入，也是LLVM Backend 的输入，是前后端的桥接语言。
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Example.png)
   ...
   ![](../../../../assets/Clang-LLVM/Clang/CodeGen.png)
...
6. **LVVM Bitcode - 生成字节码**
   ...
   ![](../../../../assets/Clang-LLVM/Clang/LVVM-Bitcode.png)
...
7. **Assemble - 生成Target相关汇编**
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Assemble.png)
...
8. **Assemble - 生成Target相关 Object(Mach-o)** 
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Object(Mach-o).png)
...
9. **Link 生成 Executable** 
   ...
   ![](../../../../assets/Clang-LLVM/Clang/Executable.png)



   ![](../../../../assets/Clang-LLVM/Clang/end.png)
